...
import mockup from "../assets/imgs/Mobile-Manager.png";
    ...
    <section className="como" id="como-funciona">
      <div className="como__inner">
        ...
        <div className="como__visual rf-reveal" ref={visual}>
          <img
            src={mockup}
            alt="Random Fighter Manager abierto en un celular, mostrando el panel del propietario"
