...
const FRASE =
  "Deja de perseguir pagos y de anotar asistencia en un cuaderno que después nadie pasa a limpio.";
...
export default function TaglineReveal() {
  ...
  return (
    <section className="tagline" aria-label="Lo que cambia con Manager">
