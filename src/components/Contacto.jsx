...
const TIPOS = [
  { valor: "demo", etiqueta: "Quiero conocer la plataforma" },
  { valor: "plan", etiqueta: "Tengo dudas sobre los planes" },
  { valor: "soporte", etiqueta: "Necesito soporte" },
  { valor: "reclamo", etiqueta: "Un reclamo" },
];

const VACIO = { nombre: "", correo: "", tipo: "demo", mensaje: "" };
...
function validar(datos) {
  ...
  if (datos.mensaje.trim().length < 15) {
    errores.mensaje = "Cuéntanos un poco más, así te respondemos algo útil.";
  }
...
export default function Contacto() {
  ...
  const enviar = (e) => {
    ...
    window.location.href =
      ...
      `?subject=${encodeURIComponent(`${asunto} desde el sitio de Manager`)}` +
  ...
  return (
    <section className="contacto" id="contacto">
      <div className="contacto__caja rf-rasgado rf-rasgado--3 rf-reveal" ref={ref}>
        ...
        <p className="contacto__texto">
          Cuántos alumnos tienes, qué disciplinas enseñas y qué te está
          costando administrar hoy. Te respondemos con algo concreto, no con
          un folleto.
        </p>
